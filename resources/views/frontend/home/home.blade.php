...
<html lang="en">
  ...
  <body>
    ...
    <section id="wsus__mobile_menu">
      <span class="wsus__mobile_menu_close"><i
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
              <ul class="wsus_mobile_menu_category">
                ...
                <li><a href="#" class="accordion-button collapsed"
                    ...
                    aria-expanded="false"
                    aria-controls="flush-collapseThreer"><i
                      class="fas fa-tv"></i> electronics</a>
      ...
      <div class="container">
        <div class="brand_border">
          <div class="row brand_slider">
            ...
            <div class="col-xl-2">
              <div class="wsus__brand_logo">
                <img src="{{ asset('frontend/images/brand_logo_2.jpg') }}"
            ...
            <div class="wsus__hot_deals_offer">
              ...
              <div class="wsus__hot_deals_text">
                <a class="wsus__hot_title"
                  href="product_details.html">portable mobile Speaker</a>
                <p class="wsus__rating">
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
            ...
            <div class="col-xl-12">
              <div class="wsus__section_header justify-content-start">
                <div class="monthly_top_filter2 mb-1">
                  ...
                  <button class="me-0"
                    data-filter=".wata">Watches</button>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-xl-6 col-lg-6">
                <div class="row">
                  <div class="col-12">
                    <div class="wsus__single_banner_content single_banner_2">
                      <div class="wsus__single_banner_img">
                        <img src="images/single_banner_55.jpg"
                  ...
                  <div class="col-12 mt-lg-4">
                    <div class="wsus__single_banner_content">
                      <div class="wsus__single_banner_img">
                        <img src="images/single_banner_66.jpg"
                          alt="banner" class="img-fluid w-100">
                      </div>
                      <div class="wsus__single_banner_text">
          ...
          <div class="col-xl-4 col-sm-7 col-md-8 col-lg-5">
            <div class="wsus__footer_content wsus__footer_content_2">
              ...
              <div class="footer_payment">
                ...
                <img src="images/credit2.png" alt="card"
                  class="img-fluid">
              </div>
            </div>
          </div>
